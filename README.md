...
- `writing/index.html` is the complete catalog of 48 public writing entries by Anni McHenry.
- `writing/*/index.html` contains the individual Fieldlight reading surfaces.
- `continuity/` maps evidence-backed connections across all 53 reading surfaces, records an explicit public baseline, and provides device-local reader state.
